...
<div align="center">
  <h3>"02LMM: From Zero to Large Multimodal Model"</h3>
</div>
...
> 02LMM Project Notice  
> This repository is a deep-dive project based on MiniMind, named **02LMM (Zero to Large Multimodal Model)**.  
> Why 02LMM? In the era where native multimodal models like DeepSeek-V3/R1 and GPT-4o are becoming the standard, we shouldn't stop at LLMs. This project aims to document the journey from scratch to building a **Large Multimodal Model (LMM)** that can see, hear, and speak.  
> All notes and documentation outlines live under [Doc](./Doc/), initially produced with the Vibe Writing LLM and then curated as personal study notes closely linked to this codebase (model/, trainer/, scripts/, etc.).
